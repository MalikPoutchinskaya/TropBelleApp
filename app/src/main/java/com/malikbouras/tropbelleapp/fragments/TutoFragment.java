package com.malikbouras.tropbelleapp.fragments;
...
public class TutoFragment extends Fragment {
    ...
    public static TutoFragment newInstance(int backgroundColor, int page) {
        TutoFragment frag = new TutoFragment();
        Bundle b = new Bundle();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        background.setBackgroundColor(ContextCompat.getColor(view.getContext(), mBackgroundColor));
    }
